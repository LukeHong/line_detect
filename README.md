...
In this project you will detect # **Finding Lane Lines on the Road**
...
A possible improvement would be to tuning the parameter of canny edge and hough lines.
lane lines in images using Python and OpenCV.  OpenCV means "Open-Source Computer Vision", which is a package that has many useful tools for analyzing images.  
